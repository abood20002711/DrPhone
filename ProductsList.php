...
if (isset($_SESSION['dashbord'])) {
    // Set the page title as 'Products List'
    $PageTilte = "Products List";
    ...
    <div class="content">
        ...
        <div class="form-add Proudact-List">
            <div class="sec-title" style="display: flex;align-items: center;justify-content: space-between;">
                ...
                <a href="AddProduct.php" class="btn btn-primary">Add new
                    prodact</a>
            </div>
        </div>
        <!-- End prodact List header -->
        <!-- Start prodact List Body -->
                            ...
                            <tbody>
                                ...
                                foreach ($result as $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td class='actions'>
                                            <a title="Edit Proudact" href="UpdatePro.php?id=<?php echo $item['ID'] ?>"
                                                class="action"><i class="fa-regular fa-pen-to-square"></i></a>
                                            <a title="Remove Proudact" href="ProductsList.php?id=<?php echo $item['ID'] ?>"
