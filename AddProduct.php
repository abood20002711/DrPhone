...
if (isset($_SESSION['dashbord'])) {
    ...
    // Set the page title as 'Add Product'
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt = $con->prepare("INSERT INTO myshop.items (ItemName, Category, sCategory, Description, Quantity, SalePrice, Price, image) VALUES 
                                                            (:ItemName, :Category, :sCategory, :Description, :Quantity, :SalePrice, :Price, :image)");
        ...
        Swal.fire(
        'Good job!',
        'Add Product completed successfully',
        'success'
                    )
    </script>";
    }
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Quantity" id="" class="form-control" required
                                        placeholder="Number of the item in stock">
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="form-group">
