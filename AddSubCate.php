...
if (isset($_SESSION['dashbord'])) {
    ...
    // Set the page title as 'Add Sub Category'
    $PageTilte = "Add Sub Category";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt = $con->prepare("INSERT INTO myshop.subcategory (SubCatName, Description, parentID) VALUES (:SubCatName, :Description, :parentID)");
