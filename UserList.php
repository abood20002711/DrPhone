...
if (isset($_SESSION['dashbord'])) {
    // Set the page title as 'User List'
    $PageTilte = "User List";
    ...
    <div class="content">
        ...
        <div class="form-add Proudact-List">
            <div class="sec-title" style="display: flex;align-items: center;justify-content: space-between;">
                ...
                <a href="AddNewUser.php" class="btn btn-primary" style="width: 200px !important;">Add new User</a>
                            ...
                            <tbody>
                                ...
                                foreach ($result as $user) { ?>
                                    <tr>
                                        ...
                                        <td class='actions'>
                                            <a title='Edit Category' href="UpdateUser.php?id=<?php echo $user['UserID'] ?>"
                                                class="action"><i class="fa-regular fa-pen-to-square"></i></i></a>
                                            <a title='Remove Category' href="UserList.php?id=<?php echo $user['UserID'] ?>"
