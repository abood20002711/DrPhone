...
if (isset($_SESSION['dashbord'])) {
    ...
    // Set the page title as 'Add Category'
    $PageTilte = "Add Category";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt = $con->prepare("INSERT INTO myshop.Category (CategoryName, Description, parentID) VALUES (:CategoryName, :Description, :parentID)");
